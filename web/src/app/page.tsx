  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main>
        ...
        <section id="features" className="border-b border-slate-100 py-16 bg-slate-50">
        ...
        <section id="pricing" className="border-b border-slate-100 py-16 bg-slate-50">
        ...
        <footer className="py-10 text-xs text-slate-500 bg-white">
          <div className="tw-container flex flex-col items-center justify-between gap-4 border-t border-slate-200 pt-6 md:flex-row">
            <div className="space-y-1 text-center md:text-left">
              <div className="text-slate-900">BizConnect · 다인</div>
